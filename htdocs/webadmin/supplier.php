    ...
    <div class="mainer">
                ...
                <li class="active"><a href="content.php" class="icon-file-text"> 内容</a>
                    ...
                    <?php
                        if($_SESSION["user_role"]==10){
                            ...
                            echo "<li class='active'><a href='supplier.php'>商家管理</a></li>";
        ...
        <div class="admin-bread">
            ...
            <ul class="bread">
                ...
                <li><a href="../webadmin/supplier.php">商家管理</a></li>
            ...
            while($row = mysql_fetch_array($result)) {
                ...
                if ($i > ($curpage - 1) * $pageSize && $i <= $curpage * $pageSize) {
                    ...
                    // <input type='checkbox' name='id' value=".$row['article_id']."/><td>".$row["article_id"]."</td>
                        echo "<tr><td><input type='checkbox'  name='chk[]' value=".$id." /></td><td><a class='button border-blue button-little' >已激活</a></td><td><a href='../admin/lookCus.php?s=1&aid=".$aid."'>".$name."</a></td><td>".$email."</td><td>".$rdate."</td><td><a class='button border-blue button-little' href='../admin/editCus.php?s=1&aid=".$aid."'>修改</a> <a class='button border-yellow button-little' href='../admin/deleteCus.php?s=1&aid=".$aid."' onclick='{if(confirm('确认删除?')){return true;}return false;}'>删除</a></td></tr>";}
                    if($state==0){
                        echo "<tr><td><input type='checkbox' name='chk[]' value=".$id." /></td><td><a class='button border-blue button-little' >未激活</a></td><td><a href='../admin/lookCus.php?s=1&aid=".$aid."'>".$name."</a></td><td>".$email."</td><td>".$rdate."</td><td><a class='button border-blue button-little' href='../admin/lookCus.php?s=1&aid=".$aid."'>查看</a> <a class='button border-yellow button-little' href='../admin/activeCus.php?s=1&stateid=".$aid."' onclick='{if(confirm('确认发布?')){return true;}return false;}'>激活</a></td></tr>";
                    }                  
                }
            }
