    ...
    <div class="mainer">
                ...
                <li class="active"><a href="content.php" class="icon-file-text"> 内容</a>
                    ...
                    <?php
                        if($_SESSION["user_role"]==10){
                            ...
                            echo "<li class='active'><a href='blog.php'>传记管理</a></li>";
        ...
        <div class="admin-bread">
            ...
            <ul class="bread">
                ...
                <li><a href="../webadmin/blog.php">传记管理</a></li>
            </ul>
        </div>
    </div>
</div>
...
<div class="admin">
    <form method="post" action="../admin/batchBlog.php">
    <div class="panel admin-panel">
        <div class="panel-head"><strong>传记管理</strong></div>
        <div class="padding border-bottom">
            ...
            <label class="text-main"><input type="radio" name="pub" checked value="1">批量发布</label>
            &nbsp;&nbsp;
            ...
            <a href="<?php echo $_SERVER['PHP_SELF'];?>?s=<?php echo base64_encode(12);?>"><input type="button" class="button button-small border-green" value="所有传记" /></a>
            ...
            <a href="<?php echo $_SERVER['PHP_SELF'];?>?s=<?php echo base64_encode(10);?>"><input type="button" class="button button-small border-green" value="未审核" /></a>
            <br><br>
            <!-- <input type="button" class="button button-small border-blue" value="回收站" /> -->
        </div>
        <table class="table table-hover">
            <tr><th width="100">选择</th><th width="120">状态</th><th width="120">用户名</th><th width="100">职业</th><th width="*">个人描述</th><th width="200">发表时间</th><th width="100">操作</th></tr>
<?php
        ...
        $user_table = "xm_blog";
        if($s==10){
            $sql = "select * from ".$user_table." where published=0 order by id desc  "; 
        }elseif($s==11){
            $sql = "select * from ".$user_table." where published=1 order by id desc  "; 
        }else{
            ...
            while($row = mysql_fetch_array($result)) {
                ...
                if ($i > ($curpage - 1) * $pageSize && $i <= $curpage * $pageSize) {
                    ...
                    // <input type='checkbox' name='id' value=".$row['article_id']."/><td>".$row["article_id"]."</td>
                        echo "<tr><td><input type='checkbox'  name='chk[]' value=".$id." /></td><td><a class='button border-blue button-little' >已审核</a></td><td><a href='../admin/lookBlog.php?aid=".$aid."'>".$name."</a></td><td>".$work."</td><td>".$des."</td><td>".$created."</td><td><a class='button border-blue button-little' href='../admin/editBlog.php?aid=".$aid."'>修改</a> <a class='button border-yellow button-little' href='../admin/deleteBlog.php?aid=".$aid."' onclick='{if(confirm('确认删除?')){return true;}return false;}'>删除</a></td></tr>";}
                    if($state==0){
                        echo "<tr><td><input type='checkbox' name='chk[]' value=".$id." /></td><td><a class='button border-blue button-little' >审核中</a></td><td><a href='../admin/lookBlog.php?aid=".$aid."'>".$name."</a></td><td>".$work."</td><td>".$des."</td><td>".$created."</td><td><a class='button border-blue button-little' href='../admin/lookBlog.php?aid=".$aid."'>查看</a> <a class='button border-yellow button-little' href='../admin/activeBlog.php?stateid=".$aid."' onclick='{if(confirm('确认发布?')){return true;}return false;}'>发布</a></td></tr>";
                    }                  
                }
            }
