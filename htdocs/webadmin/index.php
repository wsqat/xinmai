...
<div class="admin">
	<div class="line-big">
        ...
        <div class="xm9">
            ...
            <div class="alert">
                <h4>后台功能介绍</h4>
                <p class="text-gray padding-top"><b>超级管理员</b>可以发布<br>三农资讯;三农知识;三农文化;<br>审核文章;
    ...
    //                             echo "发布人员</p><a class='button bg-dot icon-code' href='../admin/publish.php'>招生简章</a> "; 
				...
				// 			}
						if($_SESSION["user_role"]==10)
							{
                            echo "超级管理员</p>"; 
							echo "<a class='button bg-dot icon-code' href='../admin/pub2.php?type=news'>三农资讯</a> ";
                            echo "<a class='button bg-dot icon-code' href='../admin/pub.php?type=know'>三农知识</a> "; 
                            echo "<a class='button bg-dot icon-code' href='../admin/pub.php?type=cult'>三农文化</a> "; 
			...
			<div class="panel">
                ...
                <table class="table">
                    ...
                    <tr><td align="right">Web服务器：</td><td>Apache</td><td align="right">主页：</td><td><a href="#" target="_blank"><?php echo $_SERVER["HTTP_HOST"]; ?></a></td></tr>
                    <tr><td align="right">程序语言：</td><td><?php echo "PHP/".PHP_VERSION;?></td><td align="right">客户端IP：</td><td>
                        <?php echo $_SERVER['REMOTE_ADDR'];?>
                    </td></tr>
                    <tr><td align="right">数据库：</td><td>MYSQL</td><td align="right">群交流：</td><td><a target="_blank" href="http://shang.qq.com/wpa/qunwpa?idkey=2c3775ddce49e18f34e41cdf7cba57a13bea793f9d24c884ca15dd3c8e1b2397"><img border="0" src="http://pub.idqqimg.com/wpa/images/group.png" alt="团队开发" title="团队开发"></a>282859992(点击加入)</td></tr>
                </table>
            </div>
        </div>
    </div>
