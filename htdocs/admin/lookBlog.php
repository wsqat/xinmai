...
<div class="admin">
  ...
  <div class="form-group">
    ...
    <div class="x4">
      	 <strong><label for="content"><?php echo $nation;?></label></strong>
    </div>
  </div>
	...
	<div class="form-group">	
    	...
    	<div class="x4">
        	  <strong><label for="title"><?php echo $work;?></label></strong>
    	</div>
  	</div>
    ...
    <div class="form-group">  
      ...
      <div class="x4">
            <strong><label for="title"><?php echo $des;?></label></strong>
      </div>
    </div>
