...
<div class="admin">
	...
	<form action="dealpub3.php" method="post" enctype="multipart/form-data">
		<p>
            ...
            <label for="editor1" style="font-size:26px;">上传图片路径:</label>
            <input type="text" name="imgsrc" style="width:400px;hight:30px;">                      <br>
			...
			<script id="editor" type="text/plain" name='editor1' style="width:940px;height:500px;"></script>
