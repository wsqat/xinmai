...
$title = stripslashes(trim($_POST['q']));
...
//echo $title;
$array = mysql_fetch_assoc(mysql_query("select * from xm_product 
        ...
        <div class="type1">
            <?php
                ...
                //for($index=1;$index<7;$index++){
                    $sql = "select * from xm_product
    where title like BINARY '%".$title."%' order by id desc  limit 8 ";
                    //echo $sql;
