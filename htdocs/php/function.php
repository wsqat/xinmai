...
//alert输出信息  重定向至首页
//防乱码
function echo_message($message , $url,$nid){
	...
	if($url == 1){
		...
		echo "<script charset='utf-8' type='text/javascript'>alert('$message');window.location.href='info.php?id=$nid';</script>";
	}else if($url == 6){
		...
		echo "<script charset='utf-8' type='text/javascript'>alert('$message');window.location.href='../webadmin/index.php';</script>";
	}else if($url == 10){
		echo "<script charset='utf-8' type='text/javascript'>alert('$message');window.location.href='bill.php';</script>";
	}elseif($url==-1){
    echo"<script>alert('$message');history.go(-1);</script>";  
  }else if($url == 11){
    echo "<script charset='utf-8' type='text/javascript'>alert('$message');window.location.href='../webadmin/customer.php';</script>";
  }else if($url == 12){
    echo "<script charset='utf-8' type='text/javascript'>alert('$message');window.location.href='../webadmin/supplier.php';</script>";
  }else if($url == 13){
    echo "<script charset='utf-8' type='text/javascript'>alert('$message');window.location.href='../webadmin/blog.php';</script>";
  }else if($url == 14){
    echo "<script charset='utf-8' type='text/javascript'>alert('$message');window.location.href='../webadmin/product.php';</script>";
  }
}
